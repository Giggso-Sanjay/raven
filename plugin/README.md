...
3. Select the `raven/plugin/` folder
4. Done — 63 skills and 10 guard agents load automatically

## What's included

- **63 skills** — Andie v6.3 with mode splitting, 6 Kaizen methods, Guru, capability routing. All domain specialists including ML, Graph DB, Workflow, MLOps. Raven core skills.
...
- **12 slash commands** — /raven-debug, /raven-review, /raven-approve, /raven-harden, /raven-incident, and more
...
- **Honesty pass** — docs now match code: event-driven guards (not "always-on"),
  ...
  verified **63 skills** (was mislabelled 60/46/55).
...
- 63 skills · 10 guard agents · 15 scripts.
...
Pull the latest repo and re-select the `raven/plugin/` folder.
