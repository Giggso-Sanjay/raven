...
**One plugin.** File: `raven-plugin-v5.5.2.zip` (built by `bash plugin/make-plugin.sh`).
...
Or unzip `raven-plugin-v5.5.2.zip` and `claude plugin install /path/to/extracted`.
...
```bash
unzip raven-plugin-v5.5.2.zip -d raven-plugin
